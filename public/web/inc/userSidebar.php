    ...
    <div class="sidebar-nav navbar-collapse"> 
      ...
      <div class="userprofile text-center">
        <div class="userpic">
          ...
          <a href="" title="切换至后台用户" class="btn btn-primary settingbtn"><i class="fa fa-random"></i></a>
          <!-- 判断是否有后台权限，有后台权限显示此按钮后可互相切换 -->
        </div>
      ...
      <!-- user profile pic -->
	   ...
	   <ul class="nav" id="side-menu">
        ...
        <li> <a href="userFansList.php"><i class="fa fa-users fa-fw"></i> 粉丝管理</a> </li>        
        <li>
        ...
        <li>
          <a href="javascript:void(0)" class="menudropdown"><i class="fa fa-star"></i> 关注收藏 <span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li><a href="#">关注列表</a></li>
            <li><a href="#">收藏列表</a></li>
          </ul>
