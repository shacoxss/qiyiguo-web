            ...
            @foreach($tags as $tag)
                <tr>
                    ...
                    <td class="center">
                        ...
                        @if($tag->status == 2)
                            <a data-href="{{route('tag.status', [$tag->name, 4])}}" class="ajax-request btn btn-circle btn-danger ">停用</a>
                        @else
                            <a data-href="{{route('tag.status', [$tag->name, 2])}}" class="ajax-request btn btn-circle btn-success">启用</a>
                        @endif
                    </td>
                </tr>
            @endforeach
