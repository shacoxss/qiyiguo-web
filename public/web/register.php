...
<title>用户注册 - 奇异果 qiyiguo.tv</title>
      ...
      <div class="login-panel panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form>
            ...
            <div class="form-group">
              <label>重复密码</label>
              <input type="email" class="form-control" placeholder="重复密码">
            </div>
            <br>
            <!-- Change this to a button or input when using this as a form --> 
            <a href="loginSuccess.php" class="btn btn-lg btn-primary btn-block">注 册</a>
          </form>
          <br>
          <div class="row">
            <div class="col-md-12  text-center"> <a href="login.php">您还可以选用以下帐号登录,或者已经注册点此登录</a><br><br> </div>
          </div>          
