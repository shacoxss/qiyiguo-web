    ...
    <div class="col-md-4 col-md-offset-4">
      <div class="login-panel panel panel-default">
        ...
        <div class="panel-body">
          <h2 class="text-center">忘记密码 - 验证手机号</h2>
            ...
            <div class="col-md-12" style="padding-left:0;padding-right:0;">
              <button  class="btn btn-lg btn-primary btn-block" id="reg">验 证</button>
            </div>
  ...
  $('#reg').click(function(){
    ...
    if(phone.length!=11){
      ...
      $.ajax({
        ...
        success:function(data){
          if(data == 'success'){
            location.href = "{{url('forget/setPassword')}}";
          }else{
            $('.alert-danger').show();
            $('.alert-danger').text(data);
          }
