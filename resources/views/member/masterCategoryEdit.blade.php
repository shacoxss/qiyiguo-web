...
@section('content')
	<div class="row">
		<div class="col-md-12  header-wrapper" >
			...
			<p class="page-subtitle">编辑一个系统栏目</p>
		</div>
		<!-- /.col-lg-12 -->
	</div>
    <!-- /.row -->
      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-default"> 
          ...
          <div class="panel-body"> 
            ...
            <form action="{{url('member/masterCategory').'/'.$cate_info->cate_id}}" method="post" enctype="multipart/form-data">
            <!-- Tab panes -->
				<input	type="hidden" name="cate_logo" id="img" value="{{$cate_info->cate_logo}}" />
				<input	id="cate_background" type="hidden" name="cate_background" value="{{$cate_info->cate_background}}" />
						...
						@endif
							<div class="col-md-12">
								<div class="form-group col-md-6">
		                    		<label>栏目名称：</label>
									<input class="form-control " placeholder="栏目名称" value="{{$cate_info->cate_name}}" name="cate_name">
								</div>								
								<div class="form-group col-md-6">
		                    		<label>上级栏目：</label>
				                    <select class="form-control" name="cate_pid" >
				                      <option value="0">顶级栏目</option>
										@foreach($cate_list as $v)
											@if($cate_info->cate_pid == $v->cate_id)
								...
								<div class="form-group col-md-6">
		                    		<label>URL自定义</label>
									<input class="form-control " placeholder="URL自定义" value="{{$cate_info->cate_url}}" name="cate_url">
									<p class="cur">例如：/ow</p>
								</div>   
								<div class="form-group col-md-6">
		                    		<label>栏目模版：</label>
									<input class="form-control " placeholder="栏目模版" value="{{$cate_info->cate_templates}}" name="cate_templates">
				  	...
				  	<div class="col-lg-3">
						...
						<div id="crop-avatar" class="col-md-12" >
							<div class="avatar-view" title="logo上传"  style="height: 100px;width: 100px;">
								<img src="{{$cate_info->cate_logo}}" onerror="this.src='{{asset('img/100100.png')}}'" alt="Logo" id="head">
							</div>
						</div>
						<h3>背景上传</h3>
	                    <input type="file" id="background" name="cate_background" value="{{$cate_info->cate_background}}"><br/>
						<div  class="col-md-12" >
								<img class="avatar-view" src="{{$cate_info->cate_background}}" onerror="this.src='{{asset('img/200200.png')}}'" alt="Logo" id="background_img" style="height: 150px;width: 450px;" >
						</div>
				  	</div>
				  	<!-- /.col-lg-6 (nested) --> 
				<!--Tab End-->
              	...
              	<div class="tab-pane fade padding" id="SEO"> 
					<div class="form-group">
		        		<label>关键词：</label>
						<input class="form-control " placeholder="关键词" name="seo_key" value="{{$cate_info->seo_key}}">
					</div>
					<div class="form-group">
		        		<label>描述：</label>
						<textarea class="form-control" rows="3" name="seo_intro" >{{$cate_info->seo_intro}}</textarea>
					</div>  
              	</div>
