                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- Tab panes -->
                            <form action="{{url('member/links').'/'.$link->id}}" method="POST" id="create-tag">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="col-md-12">
                                                <div class="form-group col-md-4">
                                                    <label>链接名称：</label>
                                                    <input class="form-control " placeholder="链接名称" name="name" value="{{$link->name}}">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>链接URL：</label>
                                                    <input class="form-control " placeholder="链接URL" name="link_url" value="{{$link->link_url}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
